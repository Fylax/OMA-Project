        ...
        public static Problem ReadFromFile(string inputFile)
        {
                    ...
                    FileOptions.SequentialScan))
            {
                using (var file = new StreamReader(stream, Encoding.UTF8, true, 4096))
                {
                    ...
                    file.ReadLine();
                    line = file.ReadLine();
                    int[] tasksPerUser = line.Trim().Split(' ').Select(int.Parse).ToArray();
                    ...
                    for (var i = 0; i < iterations; ++i)
                    {
                        ...
                        for (var j = 0; j < cells; ++j)
                        {
                            ...
                            line = file.ReadLine();
                            matrix[j] = line.Trim().Split(' ').Select(cost => (int) float.Parse(cost,
                                NumberStyles.AllowDecimalPoint,
                                NumberFormatInfo.InvariantInfo)).ToArray();
                        }
                    ...
                    file.ReadLine();
                    line = file.ReadLine();
                    prob.Tasks = line.Trim().Split(' ').Select(int.Parse).ToArray();
                    ...
                    for (var i = 0; i < iterations; ++i)
                    {
                        ...
                        var currentTimeSlot = int.Parse(parts[1]);
                        line = file.ReadLine();
                        var userNumber = line.Trim().Split(' ').Select(int.Parse).ToArray();
